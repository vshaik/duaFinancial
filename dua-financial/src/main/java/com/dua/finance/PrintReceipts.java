...
public class PrintReceipts {
	...
	static final String RECEIPT_TEMPLATE = "C:/Work/Personal/GIT-Repos/duaFinancial/reports/DUA-2020/DUA Tax Receipt Letter 2020.rtf";
	static final String RECEIPT_FOLDER = "C:/Work/Personal/GIT-Repos/duaFinancial/reports/DUA-2020/Receipts";
	...
	public static void print() throws Exception
	{
		...
		for(Donor donor : donors) {
			...
			content = content.replaceAll("Address: XX-1-XX", donor.getAddress1());
